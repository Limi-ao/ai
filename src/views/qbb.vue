<template>
    <div class="qbb-content">
       <div class="qbb-tool">
           <ul>
               <li><i class="el-icon-male"></i><a @click="handlefs">信息发送</a></li>
               <li><i class="el-icon-date"></i><a @click="dialomenage">信息管理</a></li>
          ...
          <el-row>
            <el-col :span="4">
                <div class="grid-content bg-purple">
                    <div class="grid-top too">相同种类设备列表</div>
                    ...
                    <div style="background:#fff; height:420px;"></div>
                </div>
            </el-col>
            ...
            <!--发送界面-->
            <el-col :span="19">
                <div class="grid-content bg-purple" style="border:1px solid #BFBDBD;height:765px;">
                                    ...
                                    <div class="grid-fsright">
                                        ...
                                        <el-row>
                                            <el-col :span="24"><div class="grid-content bg-purple-dark">
                                                    <div class="grid-top too">内容显示</div>
