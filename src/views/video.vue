        ...
        <el-row>
            <el-col :span="4" style="padding:0 20px;min-width:200px;background:#ffffff">
                    ...
                    <div style="position:relative">
                        ...
                        <el-button type="text" title="搜索" icon="el-icon-search" @click="saerchTree"
                        style="color:#606060;font-size:20px;position:absolute;right:10px;top:-3px"></el-button>
                    </div>
        ...
        methods:{
            ...
            saerchTree(){
                if(this.activeName === "first"){
                    this.getAllCameras(this.filterText)
                }else{
                    this.getMyCameras(this.filterText)
                }
            },
            handleTabClick(tab){
                if(tab.name==="first"){
            ...
            // 获取所有摄像机
            getAllCameras(data){
                this.$postJson('/vedioManager/selectAllVedio.htm',{content:data}).then(res=>{
                    if(res.success === true){
