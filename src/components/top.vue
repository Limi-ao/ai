    ...
    export default {
      ...
      methods:{
        returnIndex(){
         ...
         loginOut(){
           this.$postJson('logout.htm').then(res=>{
             if(res.success === true){
        ...
        //  确认修改密码
         editPass(){
           ...
           this.$refs.ruleForm.validate((valid)=>{
             if(valid){
               this.$postJson('/indexManager/editPassword.htm',{oldPassword:this.ruleForm.oldPassword,newPassword:this.ruleForm.newPassword}).then(res=>{
                 if(res.success === true){
                   this.$message({
                     type:'success',
                     message:res.msg
